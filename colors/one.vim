...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  " Diy by qianqian for C/CPP
  call <sid>X('cppSTLconstant',     s:hue_1,  '', '')
  call <sid>X('cppSTLios',          s:hue_1,  '', '')
  call <sid>X('cppSTLtype',         s:hue_6_2,'', '')
  call <sid>X('cppSTLfunction',     s:hue_2,  '', '')
  call <sid>X('cppSTLnamespace',    s:hue_5,  '', '')
  call <sid>X('cComment',           s:mono_2, '', 'italic')
  call <SID>X("cStorageClass",      s:hue_6_2,'', '')
  " Diy by qianqian End
